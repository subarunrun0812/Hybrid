...
Shader "AE/Candle_Flame"
{
	Properties
	{
		...
		[ASEBegin][HDR]_Textures("Textures", 2D) = "white" {}
		[HDR]_TextureSample0("Texture Sample 0", 2D) = "white" {}
		_BrightnessMultiplier("Brightness Multiplier", Range( 0 , 45)) = 2.679832
		...
		[ASEEnd]_FakeGlow("Fake Glow", Range( 0 , 1)) = 0.3946598
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 panner29 = ( 0.37 * _Time.y * appendResult31 + ( ( appendResult47 * 0.1 ) + ( _NoiseScale * texCoord30 ) ));
				float4 tex2DNode1 = tex2D( _Textures, ( texCoord39 + ( texCoord39.y * ( (tex2D( _Noise, panner29 )).rg - float2( 0,0 ) ) * texCoord39.x * texCoord39.y ) ) );
				...
				surfaceDescription.Color = ( _BrightnessMultiplier * ( ( _CoreColour * tex2DNode1.r ) + ( _OuterColour * tex2DNode1.g ) + ( _BaseColour * tex2DNode1.b ) + ( _CoreColour * _FakeGlow * tex2DNode51.a ) ) ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = tex2DNode51.a;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord39 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult31 = (float2(-_FlameFlickerSpeed , -_FlameFlickerSpeed));
...
/*ASEBEGIN
Version=18912
-1913;1;1906;1011;583.9137;653.1818;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-2965.166,-20.18402;Inherit;False;Property;_NoiseScale;Noise Scale;8;0;Create;True;0;0;0;False;0;False;0.44;0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;27;300.9759,-432.9038;Inherit;False;Property;_BrightnessMultiplier;Brightness Multiplier;2;0;Create;True;0;0;0;False;0;False;2.679832;15.4;0;45;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;36;-339.332,-191.3889;Inherit;False;Property;_OuterColour;Outer Colour;6;0;Create;True;0;0;0;False;0;False;0.7924528,0.2913196,0.1756853,0;0.3136645,0.4811321,0.1838284,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;35;-321.2502,-528.7051;Inherit;False;Property;_CoreColour;Core Colour;4;0;Create;True;0;0;0;False;0;False;0.8962264,0.7863407,0.3677911,0;0.9528301,0.5165758,0.06741696,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;25;218.5188,-181.9688;Inherit;True;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;63;2;51;4
ASEEND*/
//CHKSM=BFFEEEEF6B83F9418B3B67E8487574A1B09B9FD1